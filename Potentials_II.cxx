...
/////////////////////////////////////////////////////////////////////
void Potentials::SetXMAX(int xmax) {
  TrueXMAX=xmax;
}
//////////////////////////////////////////////////////////////////////
void Potentials::SetYMAX( int ymax) {
  TrueYMAX = ymax;
}
///////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////
...
*/
  ...
  //  cout << "count  = " << count << " Xmax = " << XMAX<< " YMAX = " << YMAX << endl;
...
{				// method for iterative calculation, see: http://en.wikipedia.org/wiki/Relaxation_%28iterative_method%29
  ...
  while(1)		// calculate until accuracy is reached
	...
	break;
      ...
      //      cout << " size" << newpot.wpot.size() << endl;
      for (int x=0; x<XMAX; x++)
	  for (int y=0; y<YMAX; y++)
	    {
	      //  cout << "crash359 " << " x= " << x << " y = " << y << endl;
	      newpot.dpot[y][x]=0.0;
	      //	      cout << "crash3591 " << endl;
	      newpot.wpot[y][x]=0.0;
	    }
